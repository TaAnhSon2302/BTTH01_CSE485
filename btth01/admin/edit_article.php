            ...
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="Y-m-d H:i:s" readonly value="<?php echo $article['ngayviet'] ?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span style ="padding : 0px 22px 0px 22px"class="input-group-text" id="lblArImage">hình ảnh</span>
                        <input type="file" class="form-control" name="filehinhanh" value = "<?php echo $article['hinhanh'] ?>">
                    </div>
